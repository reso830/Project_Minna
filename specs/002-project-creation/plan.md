...
- **Dependencies**: No new npm dependencies are introduced. Dialog picking relies on standard Node `child_process` and built-in system shells (PowerShell, AppleScript, standard Linux shells).
